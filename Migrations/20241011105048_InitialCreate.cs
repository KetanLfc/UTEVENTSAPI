    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventCategories", x => x.CategoryName);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_EventCategories_CategoryName",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllowedEventRoles", x => new { x.EventId, x.EventRole });
                    table.ForeignKey(
                        name: "FK_AllowedEventRoles_Events_EventId",
                        column: x => x.EventId,
